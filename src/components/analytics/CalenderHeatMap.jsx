const CalendarHeatmap = ({ data }) => {
  ...
  return (
    <section className="w-full rounded-2xl border border-base-300 bg-base-100 p-5 shadow-sm sm:p-5">
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="hidden shrink-0 rounded-xl border border-base-300 bg-base-100 px-3 py-2 text-xs font-semibold text-base-content sm:block">
      ...
      <div className="mt-5 grid grid-cols-3 divide-x divide-base-300 border-t border-base-300 pt-4">
        <div className="pr-3">
          ...
          <p className="mt-1 text-lg font-bold text-primary">{completedDays}</p>
        </div>
        ...
        <div className="px-3">
          ...
          <p className="mt-1 text-lg font-bold text-secondary">{partialDays}</p>
        </div>
